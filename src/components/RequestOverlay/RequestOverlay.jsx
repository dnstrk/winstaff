          ...
          <form className={cl.requestDrawer}>
            ...
            <div className={cl.requestDrawer__contacts}>
              <input
                ...
                id="inpPhoneR"
                value={phoneRequest}
                onBlur={() => phoneValidation(phoneRequest)}
            ...
            <div className={cl.requestDrawer__foot}>
              <input
                ...
                id="inpTownR"
                value={townRequest}
                onBlur={(e) => townValidationMarker(e.target.id, townRequest)}
              ...
              <input
                ...
                id="inpCountR"
                value={countRequest}
                onBlur={(e) => countValidationMarker(e.target.id, countRequest)}
